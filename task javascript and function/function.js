...
3- Favorite Movie (4)
*/
const favoriteFood = [ "mansaf", "shawrmah","burger","mande","kabab"] ;
console.log (favoriteFood [4]);

const FavoriteSport =[ "football" , "swimming" ,"basketball"]
console.log(FavoriteSport .indexOf("basketball"));

const FavoriteMovie =[ "batman" , "spider man","game of thrones", " the good doctor"] ;
